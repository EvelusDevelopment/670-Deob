...
final class cha {
   ...
   final boolean a() {
      ...
      if(!var1) {
         ...
         for(int var6 = 0; var6 < this.a.length; ++var6) {
            ...
            int var9 = this.c[var7];
            int var10 = (1 << var9) - 1;
            int var11 = 0;
            if(var9 > 0) {
               var11 = pr.w[this.f[var7]].b();
            }

            for(int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.j[var7][var11 & var10];
               var11 >>>= var9;
               b[var5++] = var13 >= 0?pr.w[var13].b():0;
            }
         }
   ...
   final void a(float[] var1, int var2) {
      int var3 = this.k.length;
      int var4 = d[this.f_i - 1];
      boolean[] var5 = g;
      g[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = b(h, var6);
         var8 = a(h, var6);
         var9 = this.a(h[var7], b[var7], h[var8], b[var8], h[var6]);
         var10 = b[var6];
         int var11 = var4 - var9;
         ...
         if(var10 != 0) {
            ...
            g[var6] = true;
            if(var10 >= var13) {
               b[var6] = var11 > var9?var10 - var9 + var9:var9 - var10 + var11 - 1;
            } else {
               b[var6] = (var10 & 1) != 0?var9 - (var10 + 1) / 2:var9 + var10 / 2;
            }
         } else {
            g[var6] = false;
            b[var6] = var9;
   ...
   cha() {
      ...
      if(var1 != 1) {
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            this.e[var4] = pr.a(3) + 1;
            var5 = this.c[var4] = pr.a(2);
            if(var5 != 0) {
               this.f[var4] = pr.a(8);
            }
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.e[var7]; ++var8) {
               this.k[var5++] = pr.a(var4);
            }
         }

         if(h == null || h.length < var5) {
            h = new int[var5];
            b = new int[var5];
            g = new boolean[var5];
         }
